...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlHullWhite(
        const ANY &ObjectId,
    ...
    try {
        ...
        do { 
            ...
            errorMsg << "ERROR: qlHullWhite: " << e.what(); 
...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlModelG2(
        const ANY &ObjectId,
        const ANY &YieldCurve,
        const ANY &A,
        const ANY &Sigma,
    ...
    try {
        ...
        do { 
            std::ostringstream errorMsg; 
            errorMsg << "ERROR: qlModelG2: " << e.what(); 
            OH_LOG_MESSAGE(errorMsg.str());
...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlModelG2A(
        const ANY &ObjectId,
    ...
    try {
        ...
        do { 
            std::ostringstream errorMsg; 
            errorMsg << "ERROR: qlModelG2A: " << e.what(); 
            OH_LOG_MESSAGE(errorMsg.str());
...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlModelG2B(
        const ANY &ObjectId,
        const ANY &Trigger) throw(RuntimeException) {
    try {
        ...
        do { 
            std::ostringstream errorMsg; 
            errorMsg << "ERROR: qlModelG2B: " << e.what(); 
            OH_LOG_MESSAGE(errorMsg.str());
...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlModelG2eta(
        const ANY &ObjectId,
        const ANY &Trigger) throw(RuntimeException) {
    try {
        ...
        do { 
            std::ostringstream errorMsg; 
            errorMsg << "ERROR: qlModelG2eta: " << e.what(); 
            OH_LOG_MESSAGE(errorMsg.str());
...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlModelG2rho(
        const ANY &ObjectId,
        const ANY &Trigger) throw(RuntimeException) {
    try {
        ...
        do { 
            std::ostringstream errorMsg; 
            errorMsg << "ERROR: qlModelG2rho: " << e.what(); 
            OH_LOG_MESSAGE(errorMsg.str());
...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlModelG2sigma(
        const ANY &ObjectId,
        const ANY &Trigger) throw(RuntimeException) {
    try {
        ...
        do { 
            std::ostringstream errorMsg; 
            errorMsg << "ERROR: qlModelG2sigma: " << e.what(); 
            OH_LOG_MESSAGE(errorMsg.str());
...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlVasicek(
        const ANY &ObjectId,
        const ANY &R0,
        const ANY &A,
        const ANY &B,
    ...
    try {
        ...
        do { 
            std::ostringstream errorMsg; 
            errorMsg << "ERROR: qlVasicek: " << e.what(); 
            OH_LOG_MESSAGE(errorMsg.str());
...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlVasicekA(
        const ANY &ObjectId,
        const ANY &Trigger) throw(RuntimeException) {
    try {
        ...
        do { 
            std::ostringstream errorMsg; 
            errorMsg << "ERROR: qlVasicekA: " << e.what(); 
            OH_LOG_MESSAGE(errorMsg.str());
...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlVasicekB(
        const ANY &ObjectId,
        const ANY &Trigger) throw(RuntimeException) {
    try {
        ...
        do { 
            std::ostringstream errorMsg; 
            errorMsg << "ERROR: qlVasicekB: " << e.what(); 
            OH_LOG_MESSAGE(errorMsg.str());
...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlVasicekLambda(
        const ANY &ObjectId,
        const ANY &Trigger) throw(RuntimeException) {
    try {
        ...
        do { 
            std::ostringstream errorMsg; 
            errorMsg << "ERROR: qlVasicekLambda: " << e.what(); 
            OH_LOG_MESSAGE(errorMsg.str());
...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlVasicekSigma(
        const ANY &ObjectId,
        const ANY &Trigger) throw(RuntimeException) {
    try {
        ...
        do { 
            std::ostringstream errorMsg; 
            errorMsg << "ERROR: qlVasicekSigma: " << e.what(); 
            OH_LOG_MESSAGE(errorMsg.str());
